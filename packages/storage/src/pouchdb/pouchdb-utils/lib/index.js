...
function once(fun) {
  var called = false;
  return argsArray2(function (args) {
    /* istanbul ignore if */
    if (called) {
...
function adapterFun(name, callback) {
  return toPromise(argsArray2(function (args) {
    if (this._closed) {
...
function rev(doc, deterministic_revs) {
  ...
  if (!deterministic_revs) {
    return uuidGenV4().replace(/-/g, '').toLowerCase();
  }
...
exports.getArguments = argsArray2;
