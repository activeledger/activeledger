...
declare namespace l {
      ...
      */
      ...
      class PersistedModel extends Model {
             ...
             */
            bulkUpdate(updates: any[], options: any, callback?: () => void): Promise<void> | void;
             ...
             */
            changes(since: number, filter: any, callback?: (err: Error, changes: any[]) => void): Promise<any[]> | void;

            /**
             * Create a checkpoint
             * @param  {() => void} callback
             */
            checkpoint(callback?: () => void): Promise<void> | void;
             ...
             */
            count(where?: any, callback?: (err: Error, count: number) => void): Promise<number> | void;
             ...
             */
            create<T = any>(data?: any|any[], callback?: (err: Error, models: T|T[]) => void): Promise<T|T[]> | void;
             ...
             * @param {() => void} callback
             */
            createChangeStream(options: {where: any}, callback?: (err: Error, changes: any) => void): Promise<any> | void;
             ...
             * @param  {() => void} callback
             */
            createUpdates(deltas: any[], callback?: () => void): Promise<void> | void;
             ...
             */
            currentCheckpoint(callback?: (err: Error, currentCheckpointId: number) => void): Promise<number> | void;
             ...
             */
            destroyAll(where?: any, callback?: (err: Error, info: any, infoCount: number) => void): Promise<{ info: any, infoCount: number}> | void;
             ...
             * @param {Error} err Error object; see [Error object](docs.strongloop.com/display/LB/Error+object)
             */
            destroyById(id: any, callback?: (err: Error) => void): Promise<void> | void;
             ...
             */
            diff(since: number, remoteChanges: any[], callback?: (err: Error, result: any) => void): Promise<any> | void;
             ...
             */
            exists(id: any, callback?: (err: Error, exists: boolean) => void): Promise<boolean> | void;
             ...
             */
            findById<T = any>(id: any, filter?: {fields?: string|any|any[]; include?: string|any|any[]; }, callback?: (err: Error, instance: T) => void): Promise<T> | void;
             ...
             */
            getSourceId(callback?: (err: Error, sourceId: string) => void): Promise<string> | void;
             ...
             * @param {Error} er
             */
            rectifyChange(id: any, callback?: (err: Error) => void): Promise<void> | void;
             ...
             */
            replaceById<T = any>(id: any, data: any, options?: {validate: boolean; }, callback?: (err: Error, instance: T) => void): Promise<T> | void;
             ...
             */
            replaceOrCreate<T = any>(data: any, options?: {validate: boolean; }, callback?: (err: Error, instance: T) => void): Promise<T> | void;
             ...
             *
             */
            updateAll(where?: any, data?: any, callback?: (err: Error, info: any, infoCount: number) => void): Promise<number> | void;
             ...
             */
            upsert<T = any>(data: any, callback?: (err: Error, instance: T) => void): Promise<T> | void;
             ...
             * @param {any} model Updated model instance
             */
            upsertWithWhere<T = any>(data: any, callback?: (err: Error, instance: T) => void): Promise<T> | void;
      ...
      class AccessToken extends PersistedModel {
             ...
             */
            statfindForRequest(req: any, options?: any, callback?: (err: Error, token: AccessToken) => void): void;
